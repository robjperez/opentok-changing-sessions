...
#import "OTDefaultAudioDeviceSAMPLES.h"
...
static void update_recording_delay(OTDefaultAudioDeviceSAMPLES* device) {
                             ...
                             AudioBufferList *data)
{
    ...
    OTDefaultAudioDeviceSAMPLES *dev = (__bridge OTDefaultAudioDeviceSAMPLES*) ref_con;
...
static void update_playout_delay(OTDefaultAudioDeviceSAMPLES* device) {
